(() => {
    ...
    if (viewpassButtons.length) viewpassButtons.forEach((viewpassButton => {
    ...
    window.addEventListener("scroll", (function() {
        ...
        if (header) {
            ...
            if (scrollPosition < this.lastScrollPosition) header.classList.add("scroll-up"); else header.classList.remove("scroll-up");
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (heroSection) heroSection.appendChild(heroVideo);
        setTimeout((() => {
