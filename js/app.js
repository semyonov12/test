document.addEventListener("DOMContentLoaded", function (e) {
	...
	function initSliders() {
		if (document.querySelector('.effect__slider')) {
		...
		if (document.querySelector('.before__slider')) {
			new Swiper('.before__slider', {
				observer: true,
				observeParents: true,
				slidesPerView: 5,
				spaceBetween: 23,
	...
	// Устанавливаем время отсчета в миллисекундах (6 часов)
	const countdownTime = 6 * 60 * 60 * 1000;
